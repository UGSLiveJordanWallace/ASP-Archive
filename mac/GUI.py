...
def loading_screen(screen, loading_bar):
    app_width = 900
    app_height = 550
    ...
    '''CORRECTION NEEDED'''
    screenib = os_detect("C:/ProgramData/Wized/venv/Images/WizedLoading.ico", "@/usr/lib/wized/venv/Images/WizedLoading.xbm", NONE)
    
    screen.iconbitmap(screenib)
    screen.resizable(width = False, height = False)

    imgos = os_detect('C:/ProgramData/Wized/venv/Images/loading screen image.jpg', "/usr/lib/wized/venv/Images/loading screen image.jpg", NONE)
    img = Image.open(imgos)
    img = ImageTk.PhotoImage(img)

    canvas = Canvas(screen, width = 900, height = 550)
    canvas.pack(fill = BOTH, expand = True)
    canvas.create_image(0,0, image = img, anchor = 'nw')
    canvas.create_text(450, 125, text = 'Welcome To Wized', font = ('Courier New', 69), fill = 'palegoldenrod')

    frame_1 = Frame(canvas)
    canvas.create_window(450, 350, window = frame_1)

    loading_bar = ttk.Progressbar(frame_1, length = 400, mode = 'determinate', orient = HORIZONTAL, cursor = 'spider')
    loading_bar.pack()
...
def wiki_pedia_search():
    ...
    wiki_search_results_window = Tk()
    wiki_search_results_window.title('Search Results')

    '''Correction Needed'''
    imgos2 = os_detect('C:/ProgramData/Wized/venv/Images/favicon.ico', "@/usr/lib/wized/venv/Images/wized_logo5.jpg.xbm", NONE)
    wiki_search_results_window.iconbitmap(imgos2)
    wiki_search_results_window.config(bg = bg_color)
    wiki_search_results_window.attributes('-zoomed', True)
...
def ENG_mla_c():
    ...
    '''Correction Needed'''
    imgos3 = os_detect('C:/ProgramData/Wized/venv/Images/favicon.ico', "@/usr/lib/wized/venv/Images/wized_logo5.jpg.xbm", NONE)
...
def ENG_file_l():
    ...
    '''Correction NEEDED'''
    imgos4 = os_detect('C:/ProgramData/Wized/venv/Images/favicon.ico', "@/usr/lib/wized/venv/Images/wized_logo5.jpg.xbm", NONE)
...
def EXP_powers_3():
    ...
    try:
        ...
        solved_expo_label['text'] = f"Asnwer is: {str(exp_sum)}"
    except Exception as e:
...
'''Correction NEEDED'''
imgos5 = os_detect('C:/ProgramData/Wized/venv/Images/favicon.ico', "@/usr/lib/wized/venv/Images/wized_logo5.jpg.xbm", NONE)
...
###########################################################################################################################
imgos6 = os_detect('C:/ProgramData/Wized/venv/Images/math.png', "/usr/lib/wized/venv/Images/math.png", NONE)
...
imgos7 = os_detect('C:/ProgramData/Wized/venv/Images/science.png', "/usr/lib/wized/venv/Images/science.png", NONE)
...
'''Correction NEEDED'''
imgos8 = os_detect('C:/ProgramData/Wized/venv/Images/favicon.ico', "/usr/lib/wized/venv/Images/science.png", NONE)
...
imgos9 = os_detect('C:/ProgramData/Wized/venv/Images/ElementFinderImage.png', "/usr/lib/wized/venv/Images/ElementFinderImage.png", NONE)
...
'''Correction NEEDED'''
imgos10 = os_detect('C:/ProgramData/Wized/venv/Images/scienceMenu.png', "/usr/lib/wized/venv/Images/scienceMenu.png", NONE)
...
imgos11 = os_detect('C:/ProgramData/Wized/venv/Images/history.png', "/usr/lib/wized/venv/Images/history.png", NONE)
...
imgos12 = os_detect('C:/ProgramData/Wized/venv/Images/history.png', "/usr/lib/wized/venv/Images/history.png", NONE)
...
search_bar2.insert(0, 'Search Wikipedia Website')
...
span_btn_screen5 = Button(in_frame5, text='Spanish', font = ('Comic Sans MS', 15), width = 12, height = 1, command = lambda : showFrame(spanFrame))
span_btn_screen5.grid(row = 3, column = 0, padx = 12, pady = 15)
############################################################################################################################

imgos13 = os_detect('C:/ProgramData/Wized/venv/Images/foreign-language.png', "/usr/lib/wized/venv/Images/foreign-language.png", NONE)
...
foreign_lbl.pack()
############################################################################################################################
spanFrame = Frame(root, bg = bg_color)
############################################################################################################################
main_span_frame = Frame(spanFrame)
main_span_frame.pack(fill = BOTH, expand = 10)

my_canvas_span = Canvas(main_span_frame, bg = bg_color)
my_canvas_span.pack(side = LEFT, fill = BOTH, expand = 10)

my_scrollbar_span = ttk.Scrollbar(main_span_frame, orient=VERTICAL, command=my_canvas_span.yview)
my_scrollbar_span.pack(side=RIGHT, fill=Y)

my_canvas_span.configure(yscrollcommand=my_scrollbar_span.set)
my_canvas_span.bind('<Configure>', lambda e: my_canvas_span.configure(scrollregion=my_canvas_span.bbox("all")))

second_frame_span = Frame(my_canvas_span, bg = bg_color)

my_canvas_span.create_window((0, 0), window=second_frame_span, anchor="nw")
############################################################################################################################
span_title = Label(second_frame_span, text = 'Spanish', font = ('Palatino', 65), bg = bg_color)
span_title.grid(row = 0, column = 1, padx = 50)

Label(second_frame_span, text = 'Welcome to Spanish', bg = bg_color, font = ('lato', 20)).grid(row = 1, column = 1)

span_entity = StringVar()

span_entry = Entry(second_frame_span, font = ('lato', 30), width = 40, borderwidth = 4)
span_entry.bind("<Control_L>"+"<d>", on_delete_SPN)
span_entry.grid(row = 2, column = 1, pady = 30)

finder_btn_2 = Button(second_frame_span, text = 'Google Translate', font = ('lato', 20), command = lambda : google_translate(span_entry))
finder_btn_2.grid(row = 3, column = 1)

finder_btn_3 = Button(second_frame_span, text = 'Wordreference.com', font = ('lato', 20), command = lambda : word_translate(span_entry))
finder_btn_3.grid(row = 4, column = 1, pady = 25)

bck_btn8 = Button(second_frame_span, text = 'Main Menu', font = ('lato', 20), width = 12, height = 1, command = lambda : showFrame(frame5))
bck_btn8.grid(row = 5, column = 1, pady = 10)

Label(second_frame_span, text = '                                                        ', bg = bg_color).grid(row = 6, column = 0, pady = 20)
...
#Math Image #1
'''Correction NEEDED'''
imgos14 = os_detect('C:/ProgramData/Wized/venv/Images/mathMenu.png', "/usr/lib/wized/venv/Images/mathMenu.png", NONE)
...
#Science Image #2
'''Correction NEEDED'''
imgos15 = os_detect('C:/ProgramData/Wized/venv/Images/scienceMenu.png', "/usr/lib/wized/venv/Images/scienceMenu.png", NONE)
...
#English Image #3
'''Correction NEEDED'''
imgos16 = os_detect('C:/ProgramData/Wized/venv/Images/englishMenu.png', "/usr/lib/wized/venv/Images/englishMenu.png", NONE)
...
#History Image #4
'''Correction NEEDED'''
imgos17 = os_detect('C:/ProgramData/Wized/venv/Images/historyMenu.png', "/usr/lib/wized/venv/Images/historyMenu.png", NONE)
...
'''Correction NEEDED'''
imgos18 = os_detect('C:/ProgramData/Wized/venv/Images/foreign-languageMenu.png', "/usr/lib/wized/venv/Images/foreign-languageMenu.png", NONE)
...
'''Correction NEEDED'''
imgos19 = os_detect('C:/ProgramData/Wized/venv/Images/student-resourcesMenu.png', "/usr/lib/wized/venv/Images/student-resourcesMenu.png", NONE)
...
imgos20 = os_detect(r'C:/ProgramData/Wized/venv/logo_img.png', r"/usr/lib/wized/venv/logo_img.png", NONE)
...
web_visit = Button(content_frame, text = "Visit the wized.club website", font = ("Paramound", 15), command = lambda : Open_web("https://wized.club"))
...
teacher_center = Menu(main_menu)
main_menu.add_cascade(label = 'Teacher Center', menu = teacher_center)
teacher_center.add_command(label = 'Teacher Add', command = lambda : showFrame(teacherFrame))
#######################################################################################################
...
imgosSTOP = os_detect('C:/ProgramData/Wized/venv/Images/stop_btn.png', "/usr/lib/wized/venv/Images/stop_btn.png", NONE)
imgosPLAY = os_detect('C:/ProgramData/Wized/venv/Images/play_btn.png', "/usr/lib/wized/venv/Images/play_btn.png", NONE)
imgosPAUSE = os_detect('C:/ProgramData/Wized/venv/Images/pause_btn.png', "/usr/lib/wized/venv/Images/pause_btn.png", NONE)
imgosFOR = os_detect('C:/ProgramData/Wized/venv/Images/forward_btn.png', "/usr/lib/wized/venv/Images/forward_btn.png", NONE)
imgosBACK = os_detect('C:/ProgramData/Wized/venv/Images/backward_btn.png', "/usr/lib/wized/venv/Images/backward_btn.png", NONE)
...
for frame in (musicFrame, teacherFrame, spanFrame, wikiFrame, dictionaryFrame, engFrame, perioFrame, chemFrame, exponentFrame, trig_frame, algFrame, geoFrame, frame1, frame2, frame3, frame4, frame5, frame6):
