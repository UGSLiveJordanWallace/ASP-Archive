...
def teacherPass(teacher):
    ...
    img = Image.open('Images/loading screen image.jpg')
...
def authentication_screen():    
    ...
    screenIMG = os_detect('Images/WizedLoading.ico', "@/usr/lib/astudypal/venv/Images/WizedLoading.xbm", NONE)
...
def wiki_pedia_search():
    showFrame(wiki_search_results_window)
    ...
    wiki_exit = Button(wiki_func, text = 'Go Back', font = ('lato', 20), command = lambda: showFrame(wikiFrame))
    wiki_exit.grid(row = 2, pady = 25)
...
def ENG_mla_c():
    ...
    '''Correction Needed'''
    imgos3 = os_detect('Images/favicon.ico', "@/usr/lib/astudypal/venv/Images/wized_logo5.jpg.xbm", NONE)
...
def ENG_file_l():
    ...
    '''Correction NEEDED'''
    imgos4 = os_detect('Images/favicon.ico', "@/usr/lib/astudypal/venv/Images/wized_logo5.jpg.xbm", NONE)
...
'''Correction NEEDED'''
imgos5 = os_detect('Images/favicon.ico', "@/usr/lib/astudypal/venv/Images/wized_logo5.jpg.xbm", NONE)
...
###########################################################################################################################
imgos6 = os_detect('Images/math.png', "/usr/lib/astudypal/venv/Images/math.png", NONE)
...
imgos7 = os_detect('Images/science.png', "/usr/lib/astudypal/venv/Images/science.png", NONE)
...
'''Correction NEEDED'''
imgos8 = os_detect('Images/favicon.ico', "/usr/lib/astudypal/venv/Images/science.png", NONE)
...
imgos9 = os_detect('Images/ElementFinderImage.png', "/usr/lib/astudypal/venv/Images/ElementFinderImage.png", NONE)
...
'''Correction NEEDED'''
imgos10 = os_detect('Images/scienceMenu.png', "/usr/lib/astudypal/venv/Images/scienceMenu.png", NONE)
...
imgos11 = os_detect('Images/history.png', "/usr/lib/astudypal/venv/Images/history.png", NONE)
...
imgos12 = os_detect('Images/history.png', "/usr/lib/astudypal/venv/Images/history.png", NONE)
...
imgos13 = os_detect('Images/foreign-language.png', "/usr/lib/astudypal/venv/Images/foreign-language.png", NONE)
...
my_canvas_translator = Canvas(main_translator_frame, bg = bg_color)
my_canvas_translator.pack(side = LEFT, fill = BOTH, expand = 10)

my_scrollbar_translator = ttk.Scrollbar(main_translator_frame, orient=VERTICAL, command=my_canvas_translator.yview)
my_scrollbar_translator.pack(side=RIGHT, fill=Y)

my_canvas_translator.configure(yscrollcommand=my_scrollbar_translator.set)
my_canvas_translator.bind('<Configure>', lambda e: my_canvas_translator.configure(scrollregion=my_canvas_translator.bbox("all")))

second_frame_translator = Frame(my_canvas_translator, bg = bg_color)

my_canvas_translator.create_window((0, 0), window=second_frame_translator, anchor="nw")
############################################################################################################################
...
translator_btn_1 = Button(second_frame_translator, text = 'Google Translate', font = ('lato', 20), command = lambda : google_translate(translator_entry))
translator_btn_1.grid(row = 3, column = 1)

translator_btn_2 = Button(second_frame_translator, text = 'Wordreference.com', font = ('lato', 20), command = lambda : word_translate(translator_entry))
translator_btn_2.grid(row = 4, column = 1, pady = 25)

translator_btn_exit = Button(second_frame_translator, text = 'Main Menu', font = ('lato', 20), width = 12, height = 1, command = lambda : showFrame(frame5))
translator_btn_exit.grid(row = 5, column = 1, pady = 10)
...
#Math Image #1
'''Correction NEEDED'''
imgos14 = os_detect('Images/mathMenu.png', "/usr/lib/astudypal/venv/Images/mathMenu.png", NONE)
...
#Science Image #2
'''Correction NEEDED'''
imgos15 = os_detect('Images/scienceMenu.png', "/usr/lib/astudypal/venv/Images/scienceMenu.png", NONE)
...
#English Image #3
'''Correction NEEDED'''
imgos16 = os_detect('Images/englishMenu.png', "/usr/lib/astudypal/venv/Images/englishMenu.png", NONE)
...
#History Image #4
'''Correction NEEDED'''
imgos17 = os_detect('Images/historyMenu.png', "/usr/lib/astudypal/venv/Images/historyMenu.png", NONE)
...
'''Correction NEEDED'''
imgos18 = os_detect('Images/foreign-languageMenu.png', "/usr/lib/astudypal/venv/Images/foreign-languageMenu.png", NONE)
...
'''Correction NEEDED'''
imgos19 = os_detect('Images/student-resourcesMenu.png', "/usr/lib/astudypal/venv/Images/student-resourcesMenu.png", NONE)
...
imgos20 = os_detect(r'/logo_img.png', r"/usr/lib/astudypal/venv/logo_img.png", NONE)
...
main_menu_btn = Menu(main_menu, tearoff = False)
...
imgosSTOP = os_detect('Images/stop_btn.png', "/usr/lib/astudypal/venv/Images/stop_btn.png", NONE)
imgosPLAY = os_detect('Images/play_btn.png', "/usr/lib/astudypal/venv/Images/play_btn.png", NONE)
imgosPAUSE = os_detect('Images/pause_btn.png', "/usr/lib/astudypal/venv/Images/pause_btn.png", NONE)
imgosFOR = os_detect('Images/forward_btn.png', "/usr/lib/astudypal/venv/Images/forward_btn.png", NONE)
imgosBACK = os_detect('Images/backward_btn.png', "/usr/lib/astudypal/venv/Images/backward_btn.png", NONE)
...
'''Wikipedia Frame'''
wiki_search_results_window = Frame(root)
###############################################################
#Putting the frames onto the GUI

for frame in (wiki_search_results_window, musicFrame, teacherFrame, translatorFrame, wikiFrame, dictionaryFrame, engFrame, perioFrame, chemFrame, exponentFrame, trig_frame, algFrame, geoFrame, frame1, frame2, frame3, frame4, frame5, frame6):
    frame.grid(row = 0, column = 0, sticky = 'nsew')
